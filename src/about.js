                    ...
                    <div className="row">
                        <div className="col-lg-5 mb-5 mb-lg-0 min-h-500 ">
                            <div data-aos="flip-up" data-aos-duration="1500" className="position-relative h-100">
                                <img className="position-absolute w-100 h-100 object-fit-cover " src="https://firebasestorage.googleapis.com/v0/b/hey1-portfolio.appspot.com/o/decode%2Fwebsite%2Fimages%2Fabout.jpg?alt=media&token=74e5bf91-65a8-45d9-9af4-07e0025f54be" />
                            </div>
                        </div>
                        <div className="col-lg-7">
                            <div className="section-title position-relative mb-4">
                                <h6 className="d-inline-block position-relative text-secondary secondary-text text-uppercase pb-2">About Us</h6>
                            ...
                            <div className="row pt-3 mx-0">
                                ...
                                <div className="col-sm-3 col-6 px-0">
                                    <div className="bg-primary primary-btn text-center pt-4 pb-4">
                                        <h1 className="text-white" data-toggle="counter-up">
                                ...
                                <div className="col-sm-3 col-6 px-0">
                                    <div className="bg-secondary secondary-btn text-center pt-4 pb-4">
                                        <h1 className="text-white" data-toggle="counter-up">
