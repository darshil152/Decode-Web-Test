                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5 mb-5 mb-lg-0">
                            <div className="section-title position-relative mb-4">
                                <h6 className="d-inline-block position-relative text-secondary secondary-text text-uppercase pb-2">Testimonial</h6>
                        ...
                        <div className="col-lg-7 p-0">
                            ...
                            <OwlCarousel className='owl-carousel testimonial-carousel' items={1} loop={true} smartSpeed={600} autoplay={true} dots={false} nav={true}>
                                <div className="bg-light p-sm-5 p-3 test-height">
                                    <i className="fa fa-3x fa-quote-left text-primary primary-text mb-4"></i>
                                    ...
                                    <div className="d-flex flex-shrink-0 align-items-center mt-4">
                                        <img className="img-thumbnail w-25 me-4" src={jeel} alt="" />
                                        <div>
                                            <h5>Jeel Thumar</h5>
                                ...
                                <div className="bg-light p-sm-5 p-3 test-height">
                                    ...
                                    <div className="d-flex flex-shrink-0 align-items-center mt-4">
                                        <img className="img-thumbnail w-25 me-4" src={bantu} alt="" />
                                        <div>
                                ...
                                <div className="bg-light p-sm-5 p-3 test-height">
                                    ...
                                    <div className="d-flex flex-shrink-0 align-items-center mt-4">
                                        <img className="img-thumbnail w-25 me-4" src={dharmil} alt="" />
                                        <div>
                                ...
                                <div className="bg-light p-sm-5 p-3 test-height">
                                    ...
                                    <div className="d-flex flex-shrink-0 align-items-center mt-4">
                                        <img className="img-thumbnail w-25 me-4" src={lathiyo} alt="" />
                                        <div>
