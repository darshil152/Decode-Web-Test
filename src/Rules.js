...
export default function Rules(props) {
    ...
    const rules = ['વિદ્યાર્થી એ સંસ્થા દ્વારા આપેલા સમય પર આવવાનુ રહેશે. જો કોઇ કારણસર આવવામાં મોડું થાય અથવા રજા જોઇતી હોય તો એક દિવસ પહેલા ફેકલ્ટીને જાણ કરવી.',
        ...
        ' ઇન્સ્ટિટ્યૂટ માં દાખલ થયા પછી કઈ પણ ચીજ વસ્તુ ખાવી નહિ જો ખાતા પકડાશો તો પ્રેક્ટિકલ માં બેસવા દેવામાં આવશે નહિ .',

        ' કોર્ષ ની સમય અવધિ અંદાજિત હોય છે જે વિદ્યાર્થી ની યાદ શક્તિ તેમજ તેમના પ્રેક્ટિકલ ની સ્પીડ પર આધારિત હોય છે એટલે સમય વધારેપણ થઈ શકે.',
        ...
        ' જોબ રિલેટેડ કોર્ષ માં ઇંગ્લિશ લખતા વાંચતા આવડવુ જરૂરી હોવાથી જો ઇંગ્લિશ ના આવડતું હોય તો સ્પોકન ઇંગ્લિશનો કોર્ષ કોઇપણ ઇન્સ્ટિટ્યૂટ માંથી કરી લેવો જો કોર્ષ પૂરો થતા પહેલા ઇંગ્લિશ ના આવડતું હોય તે વિદ્યાર્થી ની જોબ ની ગેરંટી Decode Softtechની રહેશે નહિ વિદ્યાર્થી નો કોર્ષ પૂર્ણ થયા પછી તેમજ કોર્ષની ફી પૂર્ણ થયા પછી જ ઇન્ટરવ્યૂ માટેમોકલવામાં આવશે ચાલુ કોર્ષમાં ઇન્ટરવ્યૂ માં કે જોબ પર મોકલવામાં આવશે નહિ.',

        ' જોબ રિલેટેડ કોર્ષમાં કોર્ષ પૂરો થાય ત્યાર પછી ઓછા માં ઓછા 3 પ્રોજેક્ટ ફરજીયાત બનાવવાના રહેશે  ત્યારપછી થી જ કંપનીમાં ઇન્ટરવ્યૂ માટે મોકલવામાં આવશે.',

        ' Decode Softtech તરફથી જોબ પર જ્યાં મોકલવામાં આવે ત્યાં ઓછામાં ઓછા 18 મહિના નો બોન્ડ રહેશે . જો તમે એ બોન્ડ કરવા માટે તૈયાર ના હોવ તો જોબની જવાબદારી Decode Softtech ની રહેશે નહિ .',

        ' જોબ રિલેટેડ કોર્ષમાં વિદ્યાર્થી ની હાજરી ઓછામાં ઓછી 90% હોવી ફરજીયાત છે.',

        ' જો વિદ્યાર્થી સતત 3 અઠવાડિયા થી વધુ ગેરહાજર હોય તો પ્રવેશ રદ કરવામાં આવશે અને ફી પરત કરવામાં આવશે નહીં.',
    ]
